...
from models.pointnet2_utils_plus import PointNetSetAbstractionMsg,PointNetSetAbstraction,PointNetFeaturePropagation,FactorizedSelfAttention,SelfAttentionWithResidual
...
class get_model(nn.Module):
    def __init__(self, num_classes, normal_channel=False):
        ...
        self.conv_l2 = nn.Conv1d(512, 256, 1)
        self.conv_l1 = nn.Conv1d(320, 128, 1)
