...
def parse_args():
    ...
    parser.add_argument('--log_dir', type=str, default='./exp_v3_compute', help='log path')
    # parser.add_argument('--decay_rate', type=float, default=1e-4, help='weight decay')
    parser.add_argument('--npoint', type=int, default=102400, help='point Number')
    parser.add_argument('--normal', action='store_true', default=False, help='use normals')
    parser.add_argument('--config', type=str, default='/config/workspace/wc/PointMamba/part_segmentation/cfgs/config.yaml', help='config file')
    # parser.add_argument('--step_size', type=int, default=20, help='decay step for lr decay')
    # parser.add_argument('--lr_decay', type=float, default=0.5, help='decay rate for lr decay')
    parser.add_argument('--ckpts', type=str, default='/config/workspace/wc/PointMamba/ckpts/pretrain.pth', help='ckpts')
    parser.add_argument('--root', type=str, default='/config/workspace/wc/PointMamba/data/origin_segment_all_v3/',
                        help='data root')
...
def main(args):
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        for i, (points, label, target,filepath) in tqdm(enumerate(trainDataLoader), total=len(trainDataLoader), smoothing=0.9):
            ...
            # 计算FLOPS和参数量
            flops, params = thop.profile(classifier, inputs=(points,to_categorical(label, num_classes)))
