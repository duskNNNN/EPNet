...
def parse_args():
    ...
    parser.add_argument('--log_dir', type=str, required=False,default='LVPC', help='experiment root')
...
if __name__ == '__main__':
    ...
    print(f"each pointcloud file inference {(end - start)/test_len}s")