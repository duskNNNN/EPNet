...
def parse_args():
    ...
    parser.add_argument('--log_dir', type=str, default='./LVPC_compute', help='log path')
    ...
    parser.add_argument('--ckpts', type=str, default='../ckpt/pretrain.pth', help='ckpts')
    parser.add_argument('--root', type=str, default='../data/LVPC/', help='data root')
