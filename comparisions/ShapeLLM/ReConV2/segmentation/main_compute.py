...
def parse_args():
    ...
    parser.add_argument('--log_dir', type=str, default='./exp_v3_large_compute', help='log path')
    parser.add_argument('--npoint', type=int, default=102400, help='point Number')
    parser.add_argument('--normal', action='store_true', default=False, help='use normals')
    parser.add_argument('--ckpts', type=str, default='../ckpts/large.pth', help='ckpts')
    parser.add_argument('--root', type=str, default='../data/origin_segment_all_v3/',
                        help='data root')
