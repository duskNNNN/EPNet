...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default='PointGPT_B', choices=['PointGPT_S', 'PointGPT_B', 'PointGPT_L'])
    parser.add_argument('--batch_size', type=int, default=1, # 16, 32
    ...
    parser.add_argument('--log_dir', type=str,
                        default='./exp_v3_B_compute', help='log path')
    # parser.add_argument('--decay_rate', type=float, default=1e-4, help='weight decay')
    parser.add_argument('--npoint', type=int,
                        default=102400, help='point Number')
    ...
    parser.add_argument(
        '--ckpts', type=str, default='../pretrain/PointGPT-B.pth', help='ckpts')
    parser.add_argument(
        '--root', type=str, default='../data/origin_segment_all_v3/', help='data root')
