...
from models.pointnet2_utils import PointNetSetAbstractionMsgSelectNormal,PointNetFeaturePropagation,FactorizedSelfAttention,SelfAttentionWithResidual
...
class get_model(nn.Module):
    def __init__(self,npoints, num_classes, num_parts, normal_channel=0):
        ...
        self.fp1 = PointNetFeaturePropagation(in_channel=320+6+self.num_classes+additional_channel, mlp=[256, 128])
    ...
    def forward(self, xyz, cls_label):
        ...
        if self.normal_channel == 1:
            ...
            l0_points = xyz
            l0_xyz = xyz
        # l0_points = self.conv_l0_head(l0_points)
